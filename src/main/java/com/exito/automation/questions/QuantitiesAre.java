...
import static com.exito.automation.userinterfaces.CartUI.LBL_CART_QUANTITY;
...
public class QuantitiesAre implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        List<WebElementFacade> productsQuantitiesInCart = LBL_CART_QUANTITY.resolveAllFor(actor);
        //int totalQuantity = 0;
